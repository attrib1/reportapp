        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(color!=null) {
                    ...
                    resultIntent.putExtra("RESULT_STRING", output);
        ...
        if (request_code == Crop.REQUEST_CROP&& result_code == CropImageActivity.RESULT_OK) {
          ...
          /*  try {
           ...
           /* final BitmapFactory.Options options = new BitmapFactory.Options();
            ...
            inIm.setImageBitmap(BitmapFactory.decodeFile(output));
            ...
            output = getRealPathFromURI(this,uri);
            ExifInterface ei = null;
            try {

                ei = new ExifInterface(output);
            } catch (IOException e) {
                e.printStackTrace();
            }
