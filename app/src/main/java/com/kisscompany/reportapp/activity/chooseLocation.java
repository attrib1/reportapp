...
public class chooseLocation extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        get.execute("https://api.foursquare.com/v2/venues/search?client_id=LO4ENGV3CEEHAY02HPU4RI4OYAD5BDILSOHJTZ0STXM4IPDK&client_secret=M1POSZ5J5IFJ45MAIFWLYEOVJWPBNAIPISUMP5H4SRXGZKBZ&v=20140806&ll="+ Main_menu.lat+","+Main_menu.lng+"&intent=browse&radius=20&locale=th");
